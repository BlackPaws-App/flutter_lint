...
`package:blackpaws_flutter_lint`, which contains recommended lints for Flutter apps,
packages, and plugins.

The `blackpaws_flutter_lint` packages is listed as a dev_dependency in the `pubspec.yaml`
file.
...
lint configuration provided by `package:blackpaws_flutter_lint`.
